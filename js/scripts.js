$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (enteredCodeHash !== '7409a91d5689a33a7f412422dbd6f89f'
            ...
            <!-- 
                $.post('https://script.google.com/macros/s/AKfycbxYXJX2jDeSOe3SA6AX-o6ydL46ZNJagodNzmViP1r5sn8ussHs_MoWkS3w7U86hjni/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 29.89446, lng: -81.316528};
...
function initBBSRMap() {
    var la_fiesta = {lat: 29.89446, lng: -81.316528};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
